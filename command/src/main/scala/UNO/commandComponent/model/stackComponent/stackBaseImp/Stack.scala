...
import command.commandComponent.model.stackComponent.StackInterface
...
case class Stack(stackCards: List[Card]) extends StackInterface:
  def initStack(): Stack =
    ...
    val yellow = List(Card("0", "yellow"), Card("1", "yellow"), Card("2", "yellow"), Card("3", "yellow"),
      ...
      Card("9", "yellow"), Card("+2", "yellow"), Card("<-->", "yellow"), Card("Skip", "yellow"))
